                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text("Hesabinis yok mu?",style: TextStyle(color: Colors.black54,fontSize:width*0.035),),
                          Text("Hemen kaydol",style: TextStyle(color: Colors.red.shade700,fontWeight: FontWeight.bold,
                              fontStyle: FontStyle.italic,fontSize:width*0.035))
                        ],
                      ),
                      SizedBox(
                        height: width*0.08,
